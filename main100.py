...
path = './data/freq_day/csi100_Alpha158'
...
for win_len, dropout, num_layers,lr,reg,loss,d_model in parameter_combinations:
    ...
    model = TransformerModel(d_feat = 44,
                             d_model = d_model,
                             batch_size = max(2,int(8 / (num_layers / 4) / (win_len / 10) / (d_model / 256)))*4,#2048*4, 20 - 21
                             nhead = 8,
                             ...
                             model_path = '/home/qiyiyan/linsida_www/log/241005_0040/model_v0.06_t0.058.model'# '/home/qiyiyan/linsida_www/log/241001_1833/model_v0.015_t0.005.model'
                             )
